...
## Resolved
- **Asset focus:** Crypto hybrid — `docs/UNIVERSE.md` (2026-08-22).
- **GitHub remote:** https://github.com/templetwo/temple-flow
- **Crypto session + public feeds:** `docs/DATA_CONVENTIONS.md` (NY session_date; Kraken→Coinbase→Yahoo).
